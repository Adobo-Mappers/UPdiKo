 ...
 *
 * @param {{ message: string, context?: Record<string, any>, sessionId?: string | null }} payload
 * @returns {Promise<{ message: string, places: Array<Record<string, any>>, sessionId: string }>}
 */
